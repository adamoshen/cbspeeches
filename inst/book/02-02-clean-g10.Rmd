...
# Cleaning the G10 speeches

The G10 consists of eleven countries: the G7 countries, plus Belgium, Netherlands, Sweden, and
Switzerland. The cleaning process of the G10 speeches is nearly identical to that used for the G7
speeches. The most notable difference is that with the addition of countries, some typos are
introduced, which require repair.
...
## Filter speeches to G10 countries
